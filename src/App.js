      ...
      <Router>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/Measure/History/TimeHistory" element={<TimeHistory />} />
            <Route path="/Measure/History/ParameterHistory" element={<ParameterHistory />} />
            
            <Route path="/Measure/Measurement/HeartAndLungSound" element={<HeartAndLungSound />} />
            <Route path="/Measure/Measurement/BloodGlucose" element={<BloodGlucose />} />
            <Route path="/Measure/Measurement/BloodPressure" element={<BloodPressure />} />
            <Route path="/Measure/Measurement/Cardiogram" element={<Cardiogram />} />
            <Route path="/Measure/Measurement/GalvanicSkinResponse" element={<GalvanicSkinResponse />} />
            <Route path="/Measure/Measurement/Oximetry" element={<Oximetry />} />
            <Route path="/Measure/Measurement/Temperature" element={<Temperature />} />
            <Route path="/Measure/Measurement/Cardiogram/AbnormalityDetection" element={<AbnormalityDetection />} />
            <Route path="/Measure/Measurement/BloodPressure/BPWithoutCalibration" element={<BPWithoutCalibration />} />
            <Route path="/Measure/Measurement/BloodPressure/BPWithCalibration" element={<BPWithCalibration />} />
            <Route path="/Measure/Measurement/BloodPressure/BPWithCalibration/BPCalibrationProcess" element={<BPCalibrationProcess />} />
            <Route path="/Measure/Measurement/BloodPressure/BPWithCalibration/BPEstimate" element={<BPEstimate />} />
